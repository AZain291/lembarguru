...
- Notasi matematika, kimia, dan rumus sains WAJIB pakai karakter Unicode yang benar, bukan notasi ASCII kasar:
  ...
  * Simbol matematika lain: × untuk perkalian (bukan x atau *), ÷ untuk pembagian, √ untuk akar, π, ° (derajat), ≤ ≥ ≠ ≈ ∞ ∑ ∆.
  * Pecahan (SETIAP kemunculan pembilang/penyebut, di soal/opsi/pembahasan) WAJIB ditulis bersusun vertikal pakai marker "{{pembilang/penyebut}}" -- misal 2/3 ditulis {{2/3}}, BUKAN "2/3" dan BUKAN LaTeX \frac{}{} (keduanya tidak akan tampil sebagai pecahan bersusun, cuma teks/kode mentah). Marker ini otomatis digambar ulang jadi pecahan bersusun asli baik di web maupun file Word, JANGAN ragu memakainya berkali-kali dalam satu soal. ATURAN KETAT bentuk marker -- pembilang & penyebut di dalam {{...}} HARUS angka murni saja (boleh negatif di pembilang, mis. {{-3/4}}), TIDAK BOLEH ada spasi/tanda kali/operasi lain di dalamnya (SALAH: {{4 × 27/9 × 64}}, {{2a/3}}); kalau perlu menunjukkan langkah perkalian/pembagian pecahan yang belum disederhanakan, tulis pakai "/" biasa TANPA kurung kurawal (mis. "4 × 27 / 9 × 64"), marker cuma untuk pecahan yang sudah bersih berupa satu angka per pembilang/penyebut. Kalau pecahan dipangkatkan, kurung dulu lalu pangkat pakai superscript seperti biasa, contoh: ({{2/3}})².
