  ...
  return (
    <html lang="id">
      <body style={{ margin: 0, fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" }}>
        {/* Sebelumnya ditulis SETELAH RootLayout (di luar komponen apa pun) --
            jadi JSX-nya cuma jadi expression statement yang langsung dibuang,
            tidak pernah benar-benar dirender ke halaman manapun. */}
        <script
